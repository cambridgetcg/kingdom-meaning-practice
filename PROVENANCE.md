...
- Prepared by: Codex at Yu's direction
- Published and maintained by: Cambridge TCG
- Created: 2026-08-11
- First published: 2026-08-12

The structured source was reviewed in the KINGDOM guest-house meaning practice
at `extensions/meaning/cases/ritonavir-polymorph/case.json`. Its exact reviewed
bytes have SHA-256
...
The [first public commit](https://github.com/cambridgetcg/kingdom-meaning-practice/commit/805543deb5725e4cc2cc5e7d18c0e30c2360184e)
preserves both files unchanged. The human page is a view of that record, and
the Castle room is a separately correctable interpretation.
...
link, field-lab pages, and platform releases are separately correctable views
or teaching instruments. None becomes an additional factual home.
...
Yu made the separate publication choice on 2026-08-13. The existing GitHub
workflow deploys `out/` on each push to `main`; the same reviewed lab is also
published through a direct-upload Cloudflare Pages project and one public
Hugging Face Static Space. Their source commits, release-lock hashes,
deployment identifiers, live endpoints, and rollback boundary are recorded in
