...
The structured guest case is the factual home. This repository preserves its
exact reviewed bytes as the authoritative public mirror and receipt; the page
and drawing are views of that record.
The Castle room is a separately correctable interpretation, not another
scientific source.
...
manufacturing recipe, or a transfer of crystal physics into software or
people.
